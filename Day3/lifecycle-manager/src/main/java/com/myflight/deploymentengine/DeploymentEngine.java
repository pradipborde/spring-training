package com.myflight.deploymentengine;
...
import com.myflight.deploymentrules.DeploymentRule;
...
public class DeploymentEngine{
	...
	private boolean executeSSH(){ 
       ...
       try{	
           ...
           JSch jsch = new JSch();
           Session session=jsch.getSession("satyen", "localhost", 22);
           session.setPassword("satyen");
